  ...
  const renderWithFormatting = (text) => {
    ...
    return paragraphs.map((para, pIdx) => {
      ...
      return (
        <p
          key={pIdx}
          style={{ marginBottom: pIdx < paragraphs.length - 1 ? "0.5em" : 0 }}
        >
          {lines.map((line, lIdx) => [
            ...line
              .split(/(\[^]+\*)/g)
    ...
    <>
      ...
      >
        <div className="text-center">
          ...
          >
            Describe your symptoms in voice or text. Available in multiple
            languages.
          </motion.p>
        </div>
            ...
            <div className="p-2 border-t bg-white">
              <div className="flex items-center">
                ...
                >
                  <motion.div
                    ...
                    transition={
                      isRecording ? { repeat: Infinity, duration: 1 } : {}
                    }
                  >
              ...
              <div className="flex flex-col md:flex-row justify-between items-center mt-2">
                <p className="text-xs text-gray-400 mb-2 md:mb-0 font-normal">
                  Tip: Use voice input by clicking the microphone button, or
                  type your symptoms directly.
                </p>
